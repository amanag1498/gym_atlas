...
use App\Http\Controllers\Web\CommunicationController as WebCommunicationController;
...
use App\Http\Controllers\Web\Gym\MemberBiometricController as WebGymMemberBiometricController;
...
use App\Http\Controllers\Web\Gym\SmartAttendanceHubController as WebGymSmartAttendanceHubController;
...
Route::prefix('admin')
    ...
    ->group(function (): void {
        ...
        Route::get('/communications', [WebCommunicationController::class, 'index'])->name('communications.index');
        Route::post('/communications/whatsapp/onboarding', [WebCommunicationController::class, 'startOnboarding'])->name('communications.whatsapp.onboarding');
        Route::post('/communications/whatsapp/sync', [WebCommunicationController::class, 'syncTemplates'])->name('communications.whatsapp.sync');
        Route::delete('/communications/whatsapp', [WebCommunicationController::class, 'disconnect'])->name('communications.whatsapp.disconnect');
        Route::post('/communications/templates', [WebCommunicationController::class, 'storeTemplate'])->name('communications.templates.store');
        Route::put('/communications/templates/{template}', [WebCommunicationController::class, 'updateTemplate'])->name('communications.templates.update');
        Route::post('/communications/campaigns', [WebCommunicationController::class, 'storeCampaign'])->name('communications.campaigns.store');
        Route::post('/communications/campaigns/{campaign}/send', [WebCommunicationController::class, 'sendCampaign'])->name('communications.campaigns.send');
        Route::post('/communications/campaigns/{campaign}/cancel', [WebCommunicationController::class, 'cancelCampaign'])->name('communications.campaigns.cancel');
        Route::put('/communications/automations', [WebCommunicationController::class, 'storeAutomation'])->name('communications.automations.store');
        Route::post('/communications/inbox/{conversation}/reply', [WebCommunicationController::class, 'reply'])->name('communications.inbox.reply');
...
Route::prefix('gym')
    ...
    ->group(function (): void {
        ...
        Route::put('/biometric-devices/{device}', [WebGymBiometricDeviceController::class, 'update'])->name('biometric-devices.update');
        Route::post('/biometric-devices/{device}/test-connection', [WebGymBiometricDeviceController::class, 'testConnection'])->name('biometric-devices.test-connection');
        Route::post('/biometric-devices/{device}/rotate-secret', [WebGymBiometricDeviceController::class, 'rotateSecret'])->name('biometric-devices.rotate-secret');
        Route::post('/biometric-devices/{device}/toggle', [WebGymBiometricDeviceController::class, 'toggle'])->name('biometric-devices.toggle');
        Route::get('/smart-attendance-hubs', [WebGymSmartAttendanceHubController::class, 'index'])->name('smart-attendance-hubs.index');
        Route::post('/smart-attendance-hubs', [WebGymSmartAttendanceHubController::class, 'store'])->name('smart-attendance-hubs.store');
        Route::put('/smart-attendance-hubs/{hub}', [WebGymSmartAttendanceHubController::class, 'update'])->name('smart-attendance-hubs.update');
        Route::post('/smart-attendance-hubs/{hub}/toggle', [WebGymSmartAttendanceHubController::class, 'toggle'])->name('smart-attendance-hubs.toggle');
        Route::post('/smart-attendance-hubs/{hub}/rotate-secret', [WebGymSmartAttendanceHubController::class, 'rotateSecret'])->name('smart-attendance-hubs.rotate-secret');
        Route::post('/biometric-events/{event}/resolve', [WebGymBiometricDeviceController::class, 'resolveEvent'])->name('biometric-events.resolve');
        Route::get('/members/{member}/biometrics', [WebGymMemberBiometricController::class, 'show'])->name('members.biometrics.show');
        Route::post('/members/{member}/biometrics', [WebGymMemberBiometricController::class, 'store'])->name('members.biometrics.store');
        Route::post('/member-biometric-links/{link}/confirm', [WebGymMemberBiometricController::class, 'confirm'])->name('members.biometrics.confirm');
        Route::post('/member-biometric-links/{link}/revoke', [WebGymMemberBiometricController::class, 'revoke'])->name('members.biometrics.revoke');
