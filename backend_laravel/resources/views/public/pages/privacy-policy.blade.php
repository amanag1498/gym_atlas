                ...
                <div class="col-lg-10 ftco-animate public-reveal">
                    <div class="atlas-card p-4 p-md-5">
                        ...
                        <div style="color: #475569; line-height: 1.95; font-size: 1rem; display: grid; gap: 1rem;">
                            <p class="mb-0">Atlas collects account and profile details, authentication identifiers, gym memberships, trainer relationships, workout and diet-plan activity, attendance, progress records, messages, notification preferences, and support requests needed to provide the member and trainer apps.</p>
                            <p class="mb-0">Chat safety records include acceptance of messaging rules, user blocks, reports, selected report reasons, and any message linked to a report. Authorized personnel may review reported conversations and related account information to investigate abuse, enforce the Terms, protect users, and meet legal obligations.</p>
                            <p class="mb-0">With a member's permission, Atlas Member can read step count, walking or running distance, active calories, and approximate or precise location. Health information is used for the member's activity dashboard and sync, while location is used to find nearby gyms. Atlas does not sell health or location information.</p>
                            <p class="mb-0">Photos or documents selected through the system picker are uploaded only for user-requested profile, progress, or trainer certification features. Atlas does not request broad access to the device photo library.</p>
                            ...
                            <p class="mb-0">Members and trainers can start an account-deletion request from Settings in either app or from the <a href="{{ route('public.account-deletion') }}" class="atlas-link">account deletion page</a>. After identity verification, Atlas removes account access and personal profile data. Records that must be retained for fraud prevention, financial reconciliation, safety, or legal compliance are restricted and kept only for the required period.</p>
                            @if ($supportEmail)
