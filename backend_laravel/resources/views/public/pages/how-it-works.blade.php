@php
    $steps = [
        ...
        ['number' => '04', 'role' => 'Trainer', 'title' => 'Coach with member context', 'copy' => 'Assigned members, plans, exercises, diet guidance, notes, tasks, attendance, and progress become part of one coaching view.', 'image' => '/images/product/trainer/clients-720.webp', 'alt' => 'Gym Atlas Coach assigned clients screen.'],
        ['number' => '05', 'role' => 'Member', 'title' => 'Act, log, and understand progress', 'copy' => 'Members follow workouts and diets, log sessions and meals, review history, track progress, and stay connected through notifications and chat.', 'image' => '/images/product/member/workouts-720.webp', 'alt' => 'Gym Atlas workout selection and tracking screen.'],
    ];
@endphp
