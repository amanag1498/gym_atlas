...
<div class="flex flex-col gap-2 px-4 py-3 sm:px-6 lg:px-8 xl:flex-row xl:items-center xl:justify-between">
    <div class="flex min-w-0 items-center gap-3">
        ...
        <button type="button" id="sidebar-toggle-mobile" data-mobile-sidebar-toggle aria-controls="app-sidebar" aria-expanded="false" class="inline-flex h-9 w-9 items-center justify-center rounded-xl text-gray-500 transition hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-white xl:hidden">
