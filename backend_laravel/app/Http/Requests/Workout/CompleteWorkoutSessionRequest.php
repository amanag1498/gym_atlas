...
class CompleteWorkoutSessionRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'exercises.*.planned_distance_meters' => ['nullable', 'numeric'],
            'exercises.*.planned_speed_kph' => ['nullable', 'numeric'],
            'exercises.*.planned_pace_seconds_per_km' => ['nullable', 'integer'],
            'exercises.*.target_weight' => ['nullable', 'numeric'],
            'exercises.*.target_resistance' => ['nullable', 'numeric'],
            'exercises.*.target_machine_level' => ['nullable', 'numeric'],
