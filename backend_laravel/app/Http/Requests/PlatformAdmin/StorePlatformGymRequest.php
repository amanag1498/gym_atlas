...
class StorePlatformGymRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'branch_latitude' => ['nullable', 'numeric', 'between:-90,90', 'required_with:branch_longitude'],
            'branch_longitude' => ['nullable', 'numeric', 'between:-180,180', 'required_with:branch_latitude'],
