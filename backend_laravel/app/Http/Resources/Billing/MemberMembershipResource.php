...
class MemberMembershipResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'status' => $this->status,
            'paused_at' => $this->paused_at?->toDateString(),
            'current_paused_days' => $this->paused_at?->diffInDays(today()) ?? 0,
            'total_paused_days' => (int) $this->total_paused_days,
            'last_resumed_at' => $this->last_resumed_at?->toDateString(),
