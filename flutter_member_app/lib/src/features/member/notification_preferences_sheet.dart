...
class MemberNotificationPreferencesSheet extends StatefulWidget {
  const MemberNotificationPreferencesSheet({
    super.key,
  ...
  @override
  State<MemberNotificationPreferencesSheet> createState() =>
      _MemberNotificationPreferencesSheetState();
}

class _MemberNotificationPreferencesSheetState
    extends State<MemberNotificationPreferencesSheet> {
  bool _loading = true;
  bool _saving = false;
  String? _error;
                        ...
                        child: AnimatedSwitcher(
                          ...
                          child: _loading
                              ? const _PreferenceLoadingState(
                                  key: ValueKey('member-pref-loading'),
                                )
                              : _error != null
                              ? _PreferenceErrorState(
                                  key: const ValueKey('member-pref-error'),
                                  message: _error!,
                                  onRetry: _load,
                                )
                              : _PreferenceContent(
                                  key: const ValueKey('member-pref-content'),
        ...
        children: [
          ...
          Column(
            ...
            children: [
              ...
              Text(
                'Choose the reminders that keep your training on track.',
                maxLines: 2,
                overflow: TextOverflow.ellipsis,
