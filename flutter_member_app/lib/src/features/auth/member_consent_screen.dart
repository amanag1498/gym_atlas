...
class MemberConsentScreen extends StatefulWidget {
  const MemberConsentScreen({super.key, required this.session});

  final MemberSessionController session;

  @override
  State<MemberConsentScreen> createState() => _MemberConsentScreenState();
}
...
class _MemberConsentScreenState extends State<MemberConsentScreen> {
  ...
  Future<void> _continue() async {
    ...
    try {
      ...
      for (final item in items.where(
        (item) => item['purpose'] != 'core_account',
      )) {
  ...
  Widget build(BuildContext context) {
    ...
    final optionalItems = items
        .where((value) => value['purpose'] != 'core_account')
        .toList();
