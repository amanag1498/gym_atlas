            ...
            child: Column(
              ...
              children: [
                ...
                for (var index = 0; index < widget.lines; index++) ...[
                  SkeletonLine(widthFactor: index == widget.lines - 1 ? 0.42 : 1),
...
class _SkeletonScope extends InheritedWidget {
  ...
  static double alphaOf(BuildContext context) {
    return context.dependOnInheritedWidgetOfExactType<_SkeletonScope>()?.alpha ??
        0.12;
  }
  ...
  Widget build(BuildContext context) {
    return Column(
      children: List.generate(items, (index) {
        return Padding(
          padding: EdgeInsets.only(bottom: index == items - 1 ? 0 : AppSpacing.md),
