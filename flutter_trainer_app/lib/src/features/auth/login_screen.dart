                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ConstrainedBox(
                      ...
                      child: Text(
                        'Sign in to manage assigned members, workouts, follow-ups, progress reviews, trial leads, and gym-connected coaching actions.',
                    ...
                    Wrap(
                      ...
                      children: const [
                        ...
                        StatusBadge(label: 'Trainer Access'),
                        StatusBadge(label: 'Member Coaching'),
                      ],
                    ),
                    const SizedBox(height: 28),
                    PremiumCard(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 8),
                          Text(
                            'Your trainer role, gym assignment, member list, workout plans, and follow-up queue will load from the backend after sign-in.',
                            style: Theme.of(context).textTheme.bodyMedium,
                          ),
                            ...
                            children: [
                              Expanded(
                                child: _LoginInfoTile(
                                  ...
                                  title: 'Members',
                                  subtitle: 'Assigned clients and notes',
                                ),
                              ),
                              ...
                              Expanded(
                                child: _LoginInfoTile(
                                  ...
                                  title: 'Plans',
                                  subtitle: 'Workouts and follow-ups',
                                ),
                              ),
                            ],
                          ),
