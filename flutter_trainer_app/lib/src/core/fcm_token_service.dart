...
class TrainerFcmTokenService {
  ...
  Future<void> registerToken({required String appRole}) async {
    ...
    if (previousRegistration != null) await previousRegistration;
  ...
  Future<void> unregisterCurrentToken() async {
    ...
    if (inFlightRefreshes.isNotEmpty) await Future.wait(inFlightRefreshes);
    try {
